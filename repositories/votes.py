from schemas.votes_null import VoteNullCreate
from sqlalchemy.orm import Session
from models import models
from repositories import students as crud_students
...
def add_null_blank_votes(db: Session, votes_null: VoteNullCreate):
